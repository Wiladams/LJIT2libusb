return {
	...
	[0x04ca] = { 
		...
		products = {
			...
			[0x3014] = "Qualcoom Atheros Bluetooth",
			[0x7025] = "HP HD Webcam",
	...
	[0x152d] = { 
		...
		products = {
			...
			[0x2590] = "Seatay ATA/ATAPI Bridge",
	...
	[0x20f7] = { 
		name = "XIMEA",
		products = {
			[0x3001] = "Camera with CMOS sensor [MQ]",
			[0x3021] = "Camera with CCD sensor [MD]",
			[0x30b3] = "Camera with CMOS sensor in Vision mode [MQ]",
	...
	[0x225d] = { 
		...
		products = {
			...
			[0x0009] = "CBM Fingerprint Sensor [CBM-V3]",
			[0x000a] = "MSO1300-E3 Fingerprint Sensor",
			[0x000b] = "MSO1300 Fingerprint Sensor [MSO1300-V3]",
			[0x000c] = "MSO1350-E3 Fingerprint Sensor & SmartCard Reader",
			[0x000d] = "MSO1350 Fingerprint Sensor & SmartCard Reader [MSO1350-V3]",
